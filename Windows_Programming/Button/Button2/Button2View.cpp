...
BEGIN_MESSAGE_MAP(CButton2View, CFormView)
	...
	ON_BN_CLICKED(IDC_CHECK2, &CButton2View::OnBnClickedCheck3State)
END_MESSAGE_MAP()
...
void CButton2View::UpdateRadioButtons(int state)
{
	switch (state)
	{
	case 0: // Unchecked
...
void CButton2View::OnBnClickedCheck3State()
{
	int state_3state = m_3state.GetCheck();
	UpdateRadioButtons(state_3state);
}